...
import com.example.demogol.exceptions.ImageNotFoundException;
import com.example.demogol.repository.ImageRepository;
...
public class ImageUploadService {
    ...
    private ImageModel upLoadImageToPost(MultipartFile file, Principal principal, Long postId) throws IOException {
        ...
        imageModel.setImageBytes(file.getBytes()); // TODO:
        imageModel.setImageBytes(compressBytes(file.getBytes()));
        imageModel.setName(file.getOriginalFilename());
